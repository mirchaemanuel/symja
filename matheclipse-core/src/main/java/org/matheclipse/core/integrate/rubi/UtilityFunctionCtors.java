...
//	}
  ...
  public static IAST FunctionOfExponentialOfLinearAux(final IExpr a0, final IExpr a1, final IExpr a2, final IExpr a3, final IExpr a4, final IExpr a5) {
    return senary($sDBG(INTEGRATE_PREFIX+"FunctionOfExponentialOfLinearAux"), a0, a1, a2, a3, a4, a5);
  }

  public static IAST FunctionOfExponentialOfLinearSubst(final IExpr a0, final IExpr a1, final IExpr a2, final IExpr a3, final IExpr a4) {
