...
public class Power extends AbstractArg2 implements INumeric {
  ...
  public IExpr e2IntArg(final IInteger i0, final IInteger i1) {
    ...
    if (i1.isNegative()) {
      return F.fraction(F.C1, i0.pow(((IInteger) i1.negate()).getBigNumerator()
          .intValue()));
    }
  ...
  public IExpr e2ObjArg(final IExpr o0, final IExpr o1) {
    ...
    if (o1.equals(F.CN1)) {
      ...
      if (o0 instanceof IFraction) {
        return F.fraction(((IFraction) o0).getDenominator(), ((IFraction) o0)
            .getNumerator());
      }
    ...
    if ((o0 instanceof ISignedNumber) && ((ISignedNumber) o0).isNegative()
        && o1.equals(F.C1D2)) {
      // extract I for sqrt
    ...
    if ((o1 instanceof INumber) && o0.isAST(F.Power)) {
      ...
      if ((f0.size() == 3) && (f0.get(2) instanceof INumber)) {
        return F.function(F.Power, f0.get(1), F
            .function(F.Times, f0.get(2), o1));
      }
    }
    ...
    if (o0.isAST(F.Times)) {
      ...
      if (o1 instanceof INumber) {
        ...
        if ((f0.size() > 1) && (f0.get(1) instanceof INumber)) {
          return Times(Power(f0.get(1), o1), Power(F.ast(f0, F.Times, true, 2,
              f0.size()), o1));
        }
      }
    }
