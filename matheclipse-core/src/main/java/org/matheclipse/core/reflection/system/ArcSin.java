...
//			"ArcSin[x_NumberQ]:= -ArcSin[-x] /; SignCmp[x]<0", "ArcSin[x_NumberQ*y_]:= -ArcSin[-x*y] /; SignCmp[x]<0" };
  ...
  ArcSin[x_NumberQ]:=(-1)*ArcSin[(-1)*x]/;SignCmp[x]<0
	...
	final static IAST RULES = List(
			Set(ArcSin(Plus(Times(C1D4,Power(C5,C1D2)),C1D4)),Times(fraction(3L,10L),Pi)),
			Set(ArcSin(Plus(Times(C1D4,Power(C5,C1D2)),Times(CN1,C1D4))),Times(fraction(1L,10L),Pi)),
			Set(ArcSin(CInfinity),Times(Times(CN1,CI),CInfinity)),
			Set(ArcSin(Times(Times(C1D4,Power(C2,C1D2)),Power(Plus(Power(C5,C1D2),C5),C1D2))),Times(fraction(2L,5L),Pi)),
			Set(ArcSin(Times(Times(C1D4,Power(C2,C1D2)),Power(Plus(Times(CN1,Power(C5,C1D2)),C5),C1D2))),Times(fraction(1L,5L),Pi)),
			Set(ArcSin(Times(Times(C1D4,Plus(Times(C1D3,Power(C3,C1D2)),C1)),Power(integer(6L),C1D2))),Times(fraction(5L,12L),Pi)),
			Set(ArcSin(Times(Times(C1D4,Plus(Times(CN1D3,Power(C3,C1D2)),C1)),Power(integer(6L),C1D2))),Times(fraction(1L,12L),Pi)),
			Set(ArcSin(CI),Times(CI,ArcSinh(C1))),
			Set(ArcSin(C1D2),Times(fraction(1L,6L),Pi)),
			Set(ArcSin(Times(C1D2,Power(C2,C1D2))),Times(C1D4,Pi)),
			Set(ArcSin(Times(C1D2,Power(C3,C1D2))),Times(C1D3,Pi)),
			Set(ArcSin(Times(C1D2,Power(Plus(Power(C2,C1D2),C2),C1D2))),Times(fraction(3L,8L),Pi)),
