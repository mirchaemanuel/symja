...
public class ArcCos extends AbstractTrigArg1 implements INumeric {
	...
	// "ArcCos[0]=Pi/2", "ArcCos[1]=0", "ArcCos[I]=Pi/2-I*ArcSinh[1]",
	// "ArcCos[2^(1/2)/2]=Pi/4", "ArcCos[3^(1/2)/2]=Pi/6",
	// "ArcCos[DirectedInfinity[1]]=I*Infinity",
	// "ArcCos[1/2*(2+2^(1/2))^(1/2)]=1/8*Pi",
	// "ArcCos[1/2*(2-2^(1/2))^(1/2)]=3/8*Pi",
	// "ArcCos[1/4*5^(1/2)+1/4]=1/5*Pi",
	// "ArcCos[1/4*6^(1/2)*(1+1/3*3^(1/2))]=1/12*Pi",
	// "ArcCos[1/4*2^(1/2)*(5-5^(1/2))^(1/2)]=3/10*Pi",
