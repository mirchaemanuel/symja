...
public class ReductionPar<C extends RingElem<C>> extends ReductionAbstract<C> {
	...
	// Logger.getLogger(ReductionPar.class);
	 ...
	 *            polynomial.
	 * @param Pp
	 *            polynomial list, concurrent modification allowed.
	 ...
	 * 
	 * @param row
	 *            recording matrix, is modified.
	 * @param Pp
	 *            a polynomial list for reduction.
	 * @param Ap
	 *            a polynomial.
	 ...
	 *            polynomial.
	 * @param Pp
	 *            distributed hash table, concurrent modification allowed.
	 * @return nf(Ap) with respect to Pp.
	 */
