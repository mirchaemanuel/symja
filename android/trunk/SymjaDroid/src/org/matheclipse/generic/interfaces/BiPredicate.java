 ...
 * {@link BiFunction}, since a predicate is just a special case of a function
 * (one that returns a boolean). However, since implementing this would entail
...
public interface BiPredicate<T> {
	 ...
	 * 
	 * @return the value of this Predicate when applied to input {@code t1} and
	 *         {@code t2}.
	 */
