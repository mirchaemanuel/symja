...
public class Predicates {
	...
	private static class InASTPredicate implements Predicate<IExpr>,
			Serializable {
	 ...
	 * @return
	 */
	public static Predicate<IExpr> isTrue(final EvalEngine engine,
			final IExpr head) {
	 ...
	 * reference being tested is an argument of the given AST. It does not
