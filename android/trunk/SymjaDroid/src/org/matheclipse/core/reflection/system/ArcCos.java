...
//	};
  ...
  ArcCos[1/4+1/4*5^(1/2)]=1/5*Pi,
	...
	final static IAST RULES = List(
			Set(ArcCos(Times(Times(C1D4,Power(C2,C1D2)),Power(Plus(Times(CN1,Power(C5,C1D2)),C5),C1D2))),Times(fraction(3L,10L),Pi)),
			Set(ArcCos(Times(Times(C1D4,Plus(Times(C1D3,Power(C3,C1D2)),C1)),Power(integer(6L),C1D2))),Times(fraction(1L,12L),Pi)),
			Set(ArcCos(Times(Times(C1D4,Plus(Times(CN1D3,Power(C3,C1D2)),C1)),Power(integer(6L),C1D2))),Times(fraction(5L,12L),Pi)),
			Set(ArcCos(Times(Times(C1D4,Power(C2,C1D2)),Power(Plus(Power(C5,C1D2),C5),C1D2))),Times(fraction(1L,10L),Pi)),
			Set(ArcCos(Times(C1D2,Power(C2,C1D2))),Times(C1D4,Pi)),
			Set(ArcCos(Times(C1D2,Power(C3,C1D2))),Times(fraction(1L,6L),Pi)),
			Set(ArcCos(Times(C1D2,Power(Plus(Power(C2,C1D2),C2),C1D2))),Times(fraction(1L,8L),Pi)),
			Set(ArcCos(Times(C1D2,Power(Plus(Times(CN1,Power(C2,C1D2)),C2),C1D2))),Times(fraction(3L,8L),Pi)),
			Set(ArcCos(C1),C0),
			Set(ArcCos(C0),Times(C1D2,Pi)),
			Set(ArcCos(C1D2),Times(C1D3,Pi)),
			Set(ArcCos(CI),Plus(Times(Times(CN1,CI),ArcSinh(C1)),Times(C1D2,Pi))),
			Set(ArcCos(CInfinity),Times(CI, CInfinity)),
			Set(ArcCos(Cosh(C1)),CI),
			Set(ArcCos(Plus(Times(C1D4,Power(C5,C1D2)),C1D4)),Times(fraction(1L,5L),Pi)),
			Set(ArcCos(Plus(Times(C1D4,Power(C5,C1D2)),Times(CN1,C1D4))),Times(fraction(2L,5L),Pi))
			);
