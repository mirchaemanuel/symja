 ...
 * 
 * @version $Revision: 791237 $ $Date: 2009-07-05 08:53:13 -0400 (Sun, 05 Jul 2009) $
 */
public class Complex implements FieldElement<Complex>, Serializable  {
    ...
    public Complex acos() {
        ...
        return this.plus(this.sqrt1z().times(Complex.I)).log()
              .times(Complex.I.negate());
    }
    ...
    public Complex asin() {
        ...
        return sqrt1z().plus(this.times(Complex.I)).log()
              .times(Complex.I.negate());
    }
    ...
    public Complex atan() {
        ...
        return this.plus(Complex.I).div(Complex.I.minus(this)).log()
            .times(Complex.I.div(createComplex(2.0, 0.0)));
    }
    ...
    public Complex sqrt1z() {
        return createComplex(1.0, 0.0).minus(this.times(this)).sqrt();
    }
