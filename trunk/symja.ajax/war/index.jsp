...
<head>
	...
	<meta name="DESCRIPTION" content="MathEclipse computer algebra tool for PDA, iPhone, mobile phone">
	<meta name="KEYWORDS" content="Mathematics, pda, iPhone, mobile phone, ajax, front end, java, computer algebra, symbolic math">
<%
	String userAgent = request.getHeader("User-Agent"); 
	if( userAgent.contains("iPhone") ) {
	  out.println( "<meta name = \"viewport\" content = \"width = 320; initial-scale=1.0; maximum-scale=1.0; user-scalable=0;\">" );
	  out.println( "<link rel=\"stylesheet\" type=\"text/css\"  href=\"iphone.css\" >" );
	} else if( userAgent.contains("Safari") ) {
	  out.println( "<meta name = \"viewport\" content = \"width = 320; initial-scale=1.0; maximum-scale=1.0; user-scalable=0;\">" );
	  out.println( "<link rel=\"stylesheet\" type=\"text/css\"  href=\"iphone.css\" >" );
	} else {
	  out.println( "<meta name = \"viewport\" content = \"width = 640; initial-scale=1.0; maximum-scale=1.0; user-scalable=0;\">" );
	  out.println( "<link rel=\"stylesheet\" type=\"text/css\"  href=\"screen.css\" >" );
	}
%>
<%
...
<%
  ...
  StringBuilder buf = new StringBuilder(1024);
		...
		buf.append("<input type=\"hidden\" id=\"token\" value=\"47110815\">");
		//buf.append("\n</td></tr>\n</table>"); 
...
<tr><td colspan="2">
  <pre id="result">Result output area:</pre>
</td></tr>
