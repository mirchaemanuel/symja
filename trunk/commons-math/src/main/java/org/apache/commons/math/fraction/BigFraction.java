 ...
 * immutable.
 * 
 * @version $Revision: 795900 $ $Date: 2009-07-20 12:27:45 -0400 (Mon, 20 Jul 2009) $
 * @since 2.0
 */
public class BigFraction
     ...
     */
    public BigFraction plus(final BigFraction fraction) {
     ...
     *             if the fraction to divide by is zero.
     */
    public BigFraction div(final BigFraction fraction) {
        if (BigInteger.ZERO.equals(fraction.numerator)) {
            throw MathRuntimeException.createArithmeticException("denominator must be different from 0");
        }

        return times(fraction.reciprocal());
    }
     ...
     *             if the fraction is <code>null</code>.
     */
    public BigFraction times(final BigFraction fraction) {
     ...
     *             if the fraction is <code>null</code>.
     */
    public BigFraction minus(final BigFraction fraction) {
        if (ZERO.equals(fraction)) {
            return this;
        }
