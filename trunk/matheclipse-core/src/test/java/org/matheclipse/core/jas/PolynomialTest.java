...
public class PolynomialTest extends AbstractTestCase {
	...
	public void testPoly001() {
		...
		GenPolynomial<BigRational> poly = fJAS.expr2Poly(f);
	...
	public void testDivideRemainder002() {
		...
		GenPolynomial<BigRational> poly1 = fJAS.expr2Poly(f1);
		// -5+x
		IAST f2 = F.Plus(IntegerSym.valueOf(-5), x);
		GenPolynomial<BigRational> poly2 = fJAS.expr2Poly(f2);
	...
	public void testFactor003() {
		...
		GenPolynomial<ModInteger> poly1 = jas003.expr2Poly(f1);
	...
	public void testLegendre() {
		...
		check(result, "1/2*(-1+3*x^2)");

		obj3 = fJAS.factorTerms(P.get(3));
		ast = fJAS.integerPoly2Expr((GenPolynomial<edu.jas.arith.BigInteger>) obj3[2]);
		result = F.Times(F.fraction((java.math.BigInteger) obj3[0], (java.math.BigInteger) obj3[1]), ast);
		check(result, "1/2*(-3*x+5*x^3)");

		obj3 = fJAS.factorTerms(P.get(4));
		ast = fJAS.integerPoly2Expr((GenPolynomial<edu.jas.arith.BigInteger>) obj3[2]);
		result = F.Times(F.fraction((java.math.BigInteger) obj3[0], (java.math.BigInteger) obj3[1]), ast);
		check(result, "1/8*(3-30*x^2+35*x^4)");

		obj3 = fJAS.factorTerms(P.get(5));
		ast = fJAS.integerPoly2Expr((GenPolynomial<edu.jas.arith.BigInteger>) obj3[2]);
		result = F.Times(F.fraction((java.math.BigInteger) obj3[0], (java.math.BigInteger) obj3[1]), ast);
		check(result, "1/8*(15*x-70*x^3+63*x^5)");

		obj3 = fJAS.factorTerms(P.get(6));
		ast = fJAS.integerPoly2Expr((GenPolynomial<edu.jas.arith.BigInteger>) obj3[2]);
		result = F.Times(F.fraction((java.math.BigInteger) obj3[0], (java.math.BigInteger) obj3[1]), ast);
		check(result, "1/16*(-5+105*x^2-315*x^4+231*x^6)");

		obj3 = fJAS.factorTerms(P.get(7));
		ast = fJAS.integerPoly2Expr((GenPolynomial<edu.jas.arith.BigInteger>) obj3[2]);
		result = F.Times(F.fraction((java.math.BigInteger) obj3[0], (java.math.BigInteger) obj3[1]), ast);
		check(result, "1/16*(-35*x+315*x^3-693*x^5+429*x^7)");

		obj3 = fJAS.factorTerms(P.get(8));
		ast = fJAS.integerPoly2Expr((GenPolynomial<edu.jas.arith.BigInteger>) obj3[2]);
		result = F.Times(F.fraction((java.math.BigInteger) obj3[0], (java.math.BigInteger) obj3[1]), ast);
		check(result, "1/128*(35-1260*x^2+6930*x^4-12012*x^6+6435*x^8)");

		obj3 = fJAS.factorTerms(P.get(9));
		ast = fJAS.integerPoly2Expr((GenPolynomial<edu.jas.arith.BigInteger>) obj3[2]);
		result = F.Times(F.fraction((java.math.BigInteger) obj3[0], (java.math.BigInteger) obj3[1]), ast);
		check(result, "1/128*(315*x-4620*x^3+18018*x^5-25740*x^7+12155*x^9)");

		obj3 = fJAS.factorTerms(P.get(10));
		ast = fJAS.integerPoly2Expr((GenPolynomial<edu.jas.arith.BigInteger>) obj3[2]);
		result = F.Times(F.fraction((java.math.BigInteger) obj3[0], (java.math.BigInteger) obj3[1]), ast);
		check(result, "1/256*(-63+3465*x^2-30030*x^4+90090*x^6-109395*x^8+46189*x^10)");
	}
