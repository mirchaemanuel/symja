...
public class BinaryBindIth1st implements IUnaryIndexFunction<IExpr, IExpr> {
	 ...
	 *          predefined value.
	 */
	public BinaryBindIth1st(@NotNull final IAST constant1, @NotNull final IAST constant2) {
		super();
	...
	public IExpr apply(int index, final IExpr firstArg) {
		final IAST ast1 = (IAST) fConstant1.clone();
		final IAST ast2 = (IAST) fConstant2.clone();
		ast2.set(1, firstArg);
		ast1.set(index, ast2);
		return ast1;
	}
