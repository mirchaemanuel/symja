 ...
 *      Rational Numbers</a>
 */
public final class BigRational {// extends Number<Rational> implements
  // Field<Rational> {
  ...
  /**
   * The {@link BigRational} representing the additive identity.
   */
  public static final BigRational ZERO = new BigRational(BigInteger.ZERO,
      BigInteger.ONE);

  /**
   * The {@link BigRational} representing the multiplicative identity.
   */
   ...
   */
  private BigRational(BigInteger dividend, BigInteger divisor) {
    fNumerator = dividend;
   ...
   */
  public static BigRational valueOf(double x) {
   ...
   * Constructs an approximated rational for a given double number
   */
  public static BigRational valueOf(double x, double epsilon) {
   ...
   *           if <code>divisor == 0</code>
   */
  public static BigRational valueOf(long dividend, long divisor) {
    BigRational r;
   ...
   */
  public static BigRational valueOf(BigInteger dividend, BigInteger divisor) {
    BigRational r;
    // if (Config.SERVER_MODE) {
    // r = FACTORY.object();
    // } else {
  ...
  public static BigRational valueOf(BigRational rat) {
    BigRational r;
    // if (Config.SERVER_MODE) {
    // r = FACTORY.object();
    // } else {
   ...
   */
  public static BigRational valueOf(String chars) {
  ...
  public BigRational opposite() {
    return BigRational.valueOf(fNumerator.opposite(), fDenominator);
  }
  ...
  public BigRational times(BigRational that) {
    BigRational r = BigRational.valueOf(this.fNumerator.times(that.fNumerator),
        this.fDenominator.times(that.fDenominator)).normalize();
    return r;
  }
  ...
  public BigRational inverse() {
    ...
    return fNumerator.isNegative() ? BigRational.valueOf(fDenominator.opposite(),
        fNumerator.opposite()) : BigRational.valueOf(fDenominator, fNumerator);
  }
  ...
  public BigRational divide(BigRational that) {
    return BigRational.valueOf(this.fNumerator.times(that.fDenominator),
  ...
  public BigRational abs() {
    return BigRational.valueOf(fNumerator.abs(), fDenominator);
  }
   ...
   * @return <code>|this| > |that|</code>
   */
  public boolean isLargerThan(BigRational that) {
  ...
  public boolean equals(Object that) {
    if (that instanceof BigRational) {
      return this.fNumerator.equals(((BigRational) that).fNumerator)
          && this.fDenominator.equals(((BigRational) that).fDenominator);
    } else {
      return false;
    }
  }
