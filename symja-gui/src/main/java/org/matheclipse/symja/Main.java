...
//	 */
//	public ExecuteListener(JTextField in, DefaultListModel out, JScrollPane scroll, RootPaneContainer parent) {
//		if (in == null)
...
//	 * is then hidden.
//	 */
//	public CommandExecutor(DefaultListModel out, JTextField source, Scroller scroller, InfiniteProgressPanel progress) {
//		in = source.getText();
//		this.out = out;
//		this.source = source;
...
//
//			EventQueue.invokeLater(new Displayer(in, result, out, source, scroller, progress));
//		} catch (Throwable thrown) {
//			thrown.printStackTrace();
//			EventQueue.invokeLater(new Displayer(in, thrown.toString(), out, source, scroller, progress));
//		}
//	}
//}
...
//	 */
//	public Displayer(String in, String out, DefaultListModel sink, JTextField source, Scroller scroller,
//			InfiniteProgressPanel progress) {
//		input = in;
//		output = out;
//		this.sink = sink;
...
//
//		for (int counter = list.getFirstVisibleIndex(); counter <= list.getLastVisibleIndex(); ++counter) {
