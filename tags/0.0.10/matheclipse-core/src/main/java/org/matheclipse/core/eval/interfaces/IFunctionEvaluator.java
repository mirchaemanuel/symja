...
public interface IFunctionEvaluator extends IEvaluator {
	/**
	 * Symbolic evaluation of a function. <code>ast.get(0)</code> must
	 * contain the <i>head</i> (i.e. the function symbol) of this abstract syntax tree (AST).
	 * 
	 * @param ast
	...
	/**
	 * Numeric evaluation of a function. <code>ast.get(0)</code> must
	 * contain the <i>head</i> (i.e. the function symbol) of this abstract syntax tree (AST).
	 * 
	 * @param ast
	 *          the abstract syntax tree (AST) which should be evaluated
