...
public class CMFieldElementUtil {
  ...
  public static <C extends RingElem<C>> C[][] toArray(GenMatrix<C> a) {
    ...
    return toArray(a.matrix);
  }

  @SuppressWarnings("unchecked")
  public static <C extends RingElem<C>> C[][] toArray(List<ArrayList<C>> a) { // Array
    // only
    // once
    if (a == null) {
      return null;
  ...
  public static <C extends RingElem<C>> CMFieldElement<C>[][] toCMFieldElement(
    ...
    CMFieldElement<C>[][] va = CMFieldElementUtil.<C> toCMFieldElement(v.matrix);
    return va;
  }
