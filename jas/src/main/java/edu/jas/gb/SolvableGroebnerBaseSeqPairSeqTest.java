/*
 * $Id: SolvableGroebnerBaseSeqPairSeqTest.java 2412 2009-02-07 12:17:54Z kredel $
 */
...
public class SolvableGroebnerBaseSeqPairSeqTest extends TestCase {

    //private static final Logger logger = Logger.getLogger(SolvableGroebnerBaseSeqPairSeqTest.class);
...
/**
 * Constructs a <CODE>SolvableGroebnerBaseSeqPairSeqTest</CODE> object.
 * @param name String.
 */
   public SolvableGroebnerBaseSeqPairSeqTest(String name) {
          super(name);
   }
 ...
 */ 
 public static Test suite() {
     TestSuite suite= new TestSuite(SolvableGroebnerBaseSeqPairSeqTest.class);
     return suite;
   }
