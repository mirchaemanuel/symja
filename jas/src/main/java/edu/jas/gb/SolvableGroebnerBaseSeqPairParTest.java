/*
 * $Id: SolvableGroebnerBaseSeqPairParTest.java 3060 2010-04-02 21:39:51Z kredel $
 */
...
public class SolvableGroebnerBaseSeqPairParTest extends TestCase {
    ...
    //private static final Logger logger = Logger.getLogger(SolvableGroebnerBaseSeqPairParTest.class);
...
/**
 * Constructs a <CODE>SolvableGroebnerBaseSeqPairParTest</CODE> object.
 * @param name String.
 */
   public SolvableGroebnerBaseSeqPairParTest(String name) {
          super(name);
   }
 ...
 */ 
 public static Test suite() {
     TestSuite suite= new TestSuite(SolvableGroebnerBaseSeqPairParTest.class);
     return suite;
   }
   ...
   protected void setUp() {
       ...
       table = ring.table;
       a = b = c = d = e = null;
       psbb = new SolvableGroebnerBaseSeqPairParallel<BigRational>();
   ...
   protected void tearDown() {
       ...
       table = null;
       cfac = null;
       ((SolvableGroebnerBaseSeqPairParallel<BigRational>)psbb).terminate(); 
       psbb = null;
   }
