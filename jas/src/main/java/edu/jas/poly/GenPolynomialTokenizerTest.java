/*
 * $Id: GenPolynomialTokenizerTest.java 3493 2011-01-16 21:53:23Z kredel $
 */
...
public class GenPolynomialTokenizerTest extends TestCase {
    ...
    public static void main (String[] args) {
        if ( false ) BasicConfigurator.configure();
